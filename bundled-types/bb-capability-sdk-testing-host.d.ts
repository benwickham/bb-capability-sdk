...
import { ExperimentalHostWatchOptions, ExperimentalHostWatchListener, ExperimentalHostWatchSubscription, CapabilityRpcContract, ExperimentalHostSignals, StandardSchemaV1InferInput, StandardSchemaV1InferOutput, ExperimentalHostEntry } from '@get-bb/capability-sdk';

type HostMethodName<Contract extends CapabilityRpcContract> = keyof Contract & string;
...
interface ExperimentalHostEntryHarness<Contract extends CapabilityRpcContract, Signals extends ExperimentalHostSignals> {
 ...
 * Process crashes remain an integration concern for CapabilityHostManager tests.
 */
declare function experimental_createHostEntryHarness<Contract extends CapabilityRpcContract, Signals extends ExperimentalHostSignals>(entry: ExperimentalHostEntry<Contract, Signals>, harnessOptions?: ExperimentalCreateHostEntryHarnessOptions): ExperimentalHostEntryHarness<Contract, Signals>;
